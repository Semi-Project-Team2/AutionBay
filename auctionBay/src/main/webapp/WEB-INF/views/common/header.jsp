...
<header class="header">
    <div class="header-container">
        ...
        <div class="header-search">
            <form id="headerSearchForm" action="${pageContext.request.contextPath}/product/list" method="get" style="width: 100%;">
                <input type="text" id="headerKeywordInput" name="keyword" value="${param.keyword}" placeholder="제목 또는 작성자 검색">
            </form>
        </div>
